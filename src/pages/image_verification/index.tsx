...
function Home() {
  ...
  const handleSubmit = async () => {
    if (file) {
      ...
      Swal.fire({
        title: "Processing...",
        html: 'Please wait while the image is being processed.<br><div class="spinner-border" role="status"></div>',
      ...
      try {
        ...
        if (response.status === 200) {
          ...
          Swal.fire({
            ...
            text: "Your image has been uploaded and processed.",
            icon: "success",
  ...
  const handleClear = () => {
    ...
    Swal.fire("Cleared", "The results have been cleared.", "info");
  };
          ...
          <div className="w-1/2 flex flex-col justify-center px-8 py-12 mt-5 ">
            ...
            <div className="card w-96 flex-grow me-3 relative">
              <p>
                ...
                the image, and our advanced algorithms will analyze its
