...
function Home() {
  ...
  const handleSubmit = async () => {
    ...
    if (!isPremium && verificationsToday >= 10) {
      const result = await Swal.fire({
        title: "Daily Limit Reached",
        text: "You have reached your daily limit of 10 image verifications. Please upgrade to premium to continue.",
        icon: "warning",
        ...
        <div className="flex flex-col lg:flex-row w-full max-w-8xl">
          <div className="w-1/2 flex flex-col justify-center px-8 py-12 mt-5">
            ...
            <b className="text-1.5xl me-5">
              "Upload an image and let us verify its origin."
            </b>

            <div className="card w-96 flex-grow me-3 relative">
              <p>
                "Wondering if an image is real, edited or generated by AI? Simply upload
                the image, and our advanced image processing algorithms will analyze its
      ...
      <div className="card border border-orange-500 bg-orange-100 border-[3px] rounded-box min-h-[200px] flex-grow m-5 p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {input.map((result, index) => {
            const displayLabel = result.label === "AI human 2" ? "AI Human" : result.label;
            ...
            return (
              ...
              >
                <div className="text-lg font-semibold mb-2">{displayLabel}</div>
